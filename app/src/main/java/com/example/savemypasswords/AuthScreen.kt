        ...
        Box (contentAlignment = Alignment.Center, modifier = Modifier.fillMaxSize()) {
            Column ( horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                TextField(modifier= Modifier
                    .fillMaxWidth(0.9f)
                    .padding(10.dp), value = loginState.value, onValueChange = {loginState.value = it}, label = {Text(text = "username")})
                TextField(modifier= Modifier
                    .fillMaxWidth(0.9f)
                    .padding(10.dp), value = passwordState.value, onValueChange = {passwordState.value = it},
                ...
                Button( modifier = Modifier.fillMaxWidth(0.5f), onClick = {
                    corutineScope.launch {
                        viewModel.SetNewUser(loginState.value, passwordState.value)
                        controller.navigate(NavItems.Main.routeId){
                            this.popUpTo(0)
                        }
                    }
